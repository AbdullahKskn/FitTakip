...
public class RandevuRepository : IRandevuRepository
{
    ...
    public async Task<List<Randevu>> UyeyeAitRandevulariGetirAsync(long UyeId, int Baslangic, int Adet)
    {
    ...
    public async Task<List<Randevu>> GunlukRandevuGetirAsync(long EgitmenId, DateTime Tarih)
    {
    ...
    public async Task<List<Randevu>> UyeyeAitRandevulariTariheGoreGetirAsync(long UyeId, DateTime BaslangicTarih, DateTime BitisTarih, int Adet, int Baslangic)
    {
    ...
    public async Task<DateTime?> SonRandevuGetirAsync(long UyeId)
    {
    ...
    public async Task<int> EgitmenTariheGöreDersSayisiGetirAsync(long EgitmenId, DateTime BaslangicTarih, DateTime BitisTarih)
    {
    ...
    public async Task<List<Randevu>> EgitmenTariheGöreTumRandeculariGetirAsync(long EgitmenId, DateTime BaslangicTarih, DateTime BitisTarih)
    {
        BaslangicTarih = BaslangicTarih.Date;
        BitisTarih = BitisTarih.Date.AddHours(23).AddMinutes(59).AddSeconds(59);
